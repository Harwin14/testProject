    ...
    <div id="app">
        <section id="sidebar" :class="{ hide: isSidebarHidden }">
            ...
            <ul class="side-menu top">
                ...
                <li :class="{ active: activeMenuItem === 'store' }">
                    <router-link
                        to="/products"
                        @click="setActiveMenuItem('store')"
                    >
        ...
        <li :class="{ active: activeMenuItem === 'team' }">
          <router-link to="#" @click="setActiveMenuItem('team')">
            ...
            <span class="absolute top-[92%] left-4 font-bold text-gold text-lg mr-4 bg-green-600 p-2 rounded-lg">
                {{ date }}
                {{ timestamp }}
            </span>
        </section>
            ...
            <main class="h-[780px]">
                <div class="head-title">
                    ...
                    <a href="#" class="btn-download">
                        <i class="bx bxs-cloud-download text-black"></i>
                        <span class="text text-black">Download PDF</span>
                    </a>
                </div>
